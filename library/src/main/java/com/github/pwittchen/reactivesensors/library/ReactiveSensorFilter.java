...
public final class ReactiveSensorFilter {
   ...
   *
   * @return Predicate<ReactiveSensorEvent> predicate indicating if sensor value has changed
   */
   ...
   *
   * @return Predicate<ReactiveSensorEvent> predicate indicating if accuracy value has changed
   */
